...
export default function SafetyDashboard() {
  ...
  useEffect(() => {
    fetch("http://localhost:5000/api/safety/dashboard", {
  ...
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 className="text-xl font-semibold text-gray-900">Safety Dashboard</h1>
        <p className="mt-1 text-sm text-gray-500">Monitor fleet safety, drivers, and trip statuses.</p>
      </div>
